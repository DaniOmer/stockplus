...
from stockplus.modules.pointofsale.domain.models import PointOfSale as PointOfSaleDomain
from stockplus.modules.pointofsale.infrastructure.orm.orm import PointOfSale as PointOfSaleORM


class DjangoPointOfSaleRepository(PointOfSaleRepository):
    """
    Django implementation of the point of sale repository.
    """
    
    def _to_domain(self, orm_point_of_sale: PointOfSaleORM) -> PointOfSaleDomain:
        """
    ...
    def get_by_id(self, point_of_sale_id: int) -> Optional[PointOfSaleDomain]:
        ...
        """
        try:
            orm_point_of_sale = PointOfSaleORM.objects.get(id=point_of_sale_id)
    ...
    def get_by_company_id(self, company_id: int) -> List[PointOfSaleDomain]:
        ...
        """
        orm_points_of_sale = PointOfSaleORM.objects.filter(company_id=company_id)
    ...
    def create(self, point_of_sale: PointOfSaleDomain) -> PointOfSaleDomain:
        ...
        """
        orm_point_of_sale = PointOfSaleORM.objects.create(
    ...
    def update(self, point_of_sale: PointOfSaleDomain) -> PointOfSaleDomain:
        ...
        """
        try:
            orm_point_of_sale = PointOfSaleORM.objects.get(id=point_of_sale.id)
        except ObjectDoesNotExist:
