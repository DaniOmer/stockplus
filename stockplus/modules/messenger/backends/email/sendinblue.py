...
from stockplus.modules.messenger.backends import MissiveBackend as BaseMissiveBackend
...
"""
class MissiveBackend(BaseMissiveBackend):
    CONFSIB = False
    APISIB = False
    APIEMAIL = False
    ...
    def use_api_email(self, missive):
        ...
        try:
            ...
            if hasattr(self.missive, 'trace') and callable(self.missive.trace):
