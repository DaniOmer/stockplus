...
from builder.modules.address import models as AddressModels
from builder.modules.user import choices
...
class User(AbstractUser):
    ...
    if 'builder.modules.nationality' in settings.INSTALLED_APPS:
